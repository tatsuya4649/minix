// <minix/syslib.h> contains prototypes of C library functions to call to access
// other operating system service from within the operating system.
//
//

// prototype of system library function
#ifndef _SYSLIB_H
#define _SYSLIB_H
...
_PROTOTYPE( int sys_adjmap,(int _proc,struct mem_map *_ptr,vir_clicks _data_clicks,vir_clicks _sp));
_PROTOTYPE( int sys_copy,(int _src_proc,int _src_seg,phys_bytes _src_vir,int _dst_proc,int _dst_seg,phys_bytes _dst_vir,phys_bytes _bytes));
_PROTOTYPE( int sys_exec,(int _proc,char *_ptr,int _traced,char *_aout,vir_bytes _initpc));
_PROTOTYPE( int sys_execmap,(int _proc,struct mem_map *_ptr));
_PROTOTYPE( int sys_fork,(int _parent,int _child,int _pid,phys_clicks _shadow));
_PROTOTYPE( int sys_fresh,(int _proc,struct mem_map *_ptr,phys_clicks _dc,phys_clicks *_basep,phys_clicks *_sizep));
...
_PROTOTYPE( int sys_xit,(int _parent,int _proc,phys_clicks *_basep,phys_click *_sizep));
