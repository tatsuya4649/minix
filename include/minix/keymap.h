// <minix/keymap.h> header defines the structure that provides a special keyboard layout 
// because it provides the required character set in different languages.
//
//
...
#define C(c)	((c) & 0x1F)		// map of control code
#define A(c)	((c) | 0x80)		// set 8bits (ALT)
#define CA(c)	A(C(c))			// Control-Alt
#define L(c)	((c) | HASCAPS)		// added "Caps Lock Enables" attribute

#define EXT	0x0100			// normal function key
#define CTRL	0x0200			// control key
#define SHIFT	0x0400			// shift key
#define ALT	0x0800			// Alternate key
#define EXTKEY	0x1000			// extension key
#define HASCAPS	0x8000			// caps lock is enables
...
#define NLOCK	(0x0E + EXT)		// NUM lock
...
#define MAP_COLS	6	// number of digits in the keymap
#define NR_SCAN_CODES	0x80	// number of scan codes ( number of columns in the keymap )
