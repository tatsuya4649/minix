...
_PROTOTYPE( void dev_opcl,(int task_nr,message *mrss_ptr));
...
_PROTOTYPE( void dup_inode,(struct inode *));
...
_PROTOTYPE( void updata_times,(struct inode *rip));
...
_PROTOTYPE( void revice,(int proc_nr,int bytes));
...
_PROTOTYPE( struct buf *rahead,(struct inode *rip,block_t baselock,
